...
func (x *MetricsResponse) Reset() {
	*x = MetricsResponse{}
	mi := &file_skylr_shard_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MetricsResponse) Descriptor() ([]byte, []int) {
	return file_skylr_shard_proto_rawDescGZIP(), []int{6}
}
...
const file_skylr_shard_proto_rawDesc = "" +
	"\n" +
	"\x11skylr-shard.proto\x12\x0eskylr_shard.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x1e\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
...
var file_skylr_shard_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
