...
func (x *InputEntry) Reset() {
	*x = InputEntry{}
	mi := &file_skylr_shard_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InputEntry) Descriptor() ([]byte, []int) {
	return file_skylr_shard_proto_rawDescGZIP(), []int{7}
}
...
func (x *ScanResponse) Reset() {
	*x = ScanResponse{}
	mi := &file_skylr_shard_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *MetricsResponse) Reset() {
	*x = MetricsResponse{}
	mi := &file_skylr_shard_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MetricsResponse) Descriptor() ([]byte, []int) {
	return file_skylr_shard_proto_rawDescGZIP(), []int{9}
}
...
var file_skylr_shard_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_skylr_shard_proto_init() {
	...
	file_skylr_shard_proto_msgTypes[6].OneofWrappers = []any{
		(*Entry_ValueStr)(nil),
